...
func TestLe(t *testing.T) {
	var test = func(t *testing.T, x, y FX, want bool) {
		if got, want := Le(x, y), want; got != want {
...
func TestLe_Inf_Inf(t *testing.T) {
	defer func() {
		if r := recover(); r == nil {
...
func TestLe_NegInf_NegInf(t *testing.T) {
	defer func() {
		if r := recover(); r == nil {
			t.Errorf("The code did not panic")
		}
...
func TestLe_Infs_Infs(t *testing.T) {
	defer func() {
		if r := recover(); r == nil {
			t.Errorf("The code did not panic")
		}
...
func TestLe_NegInfs_NegInfs(t *testing.T) {
	defer func() {
		if r := recover(); r == nil {
			t.Errorf("The code did not panic")
		}
